...
class OrderExecutionResult(ExecutionResult, abc.ABC):
    ...
    def __init__(self, success, order_id: str = "", messages: Optional[list[str]] = None):
...
class MarketResult(OrderExecutionResult):
    ...
    def __init__(self, success: bool, order_id: str = '', messages: Optional[list[str]] = None, orders_matched: int = 0,
