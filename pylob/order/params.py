...
class OrderParams:
    ...
    def check_args(
        ...
        """Check for args correctness. This method is very important, since we
        do not check for this after the OrderParams object is created.
        """
        ...
        if quantity < MIN_VALUE:
            raise ValueError(f"quantity ({quantity}) must be greater than 0.01")
